#!/usr/bin/env python3
"""
Composite Enhanced Metrics Logger for Resume Training
===================================================
...
class CompositeEnhancedMetricsLogger:
    ...
    def __init__(self, dataset_key, experiment_name=None, log_dir="./training_logs", resume_from_epoch=None):
        ...
        # File paths (use consistent naming for resume)
...
# Usage example:
"""
# Example usage for resume training with composite logging:

# Create composite logger that automatically detects and continues existing logs
composite_logger = create_composite_metrics_logger(
    dataset_key=dataset_key,
    device_info=device_info, 
    training_config=training_config,
    experiment_name=experiment_name,
    resume_from_epoch=start_epoch  # This comes from checkpoint loading
)

# Rest of training loop remains the same...
# The logger will automatically append to existing logs and maintain session history
"""